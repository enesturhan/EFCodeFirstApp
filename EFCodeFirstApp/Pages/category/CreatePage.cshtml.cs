...
using EFCodeFirstApp.Models.Aggregates.CategoryAggregate.Seed;
...
namespace EFCodeFirstApp.Pages.category
{
    ...
    public class CreatePageModel : PageModel
    {
        ...
        public CreatePageModel(ICategoryRepository categoryRepository)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    foreach (var item in InputModel.Products)
                    {
                        ...
                        c.AddProduct(item.Name, item.Stock, item.Price, item.IsPromotion);
                    }
